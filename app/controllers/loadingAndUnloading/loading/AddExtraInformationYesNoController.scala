...
import pages.loadingAndUnloading.loading.AddExtraInformationYesNoPage
...
class AddExtraInformationYesNoController @Inject() (
  ...
  private val form = formProvider("loadingAndUnloading.loading.addExtraInformationYesNo")
