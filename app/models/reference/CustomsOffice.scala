...
case class CustomsOffice(id: String, name: String, countryId: String) extends Selectable {
...
object CustomsOffice {
  ...
  def listReads(config: FrontendAppConfig): Reads[List[CustomsOffice]] = Reads.list(reads(config))
