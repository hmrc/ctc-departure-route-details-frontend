...
class AddSpecificCircumstanceIndicatorYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[AddSpecificCircumstanceIndicatorYesNoView].apply(form, lrn, NormalMode)(fakeRequest, messages)

  override val prefix: String = "addSpecificCircumstanceIndicatorYesNo"
